...
echo    "      After reboot, as your regular user please run the following command to login:"
...
echo    " "
echo    "      Now either start Plexamp manually using:"
echo    "      node /home/"$USER"/plexamp/js/index.js"
echo    "      Or (preferred/recommended) enable the service and then start the Plexamp service."
echo    "      If process is running, hit ctrl+c first to stop process, then enter:"
