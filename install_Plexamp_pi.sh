...
echo "      Note !! Run PlexAmp for the first time after installation to manually add the claim token."
...
echo ""
echo "      NOTE!! A reboot is at this point needed to automatically create the symlink for autostart."
